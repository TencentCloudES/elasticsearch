...
public class ObjectSizeCalculator {
  ...
  static class ComplexObject<T> {
	    static class Node<T> {
	      ...
	      Node<T> previous;
	      Node<T> next;
	      String str = "sdjfalsdflasdaaaaaaaaaaaaaaaaaaaaaaaajfsdflasdlfalsdfs";
	    ...
	    private Node<T> last;
	    String str = "sdjfalsdflasd000000000aaaaaaaaaaaaaaaaaaaaaaaajfsdflasdlfalsdfs";
  ...
  public static void main(String args[]) {
	  ...
	  System.out.println(objectSizeCalculator.calculateObjectSize(new TestA()));
  }
